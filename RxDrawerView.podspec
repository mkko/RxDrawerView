#
#  Be sure to run `pod spec lint RxDrawerView.podspec' to ensure this is a
...
RxDrawerView is an RxSwift wrapper for DrawerView. With RxDrawerView you can use reactive approach to receive the delegate updates.
  ...
  s.homepage     = "https://github.com/mkko/RxDrawerView"
  ...
  s.source       = { :git => "https://github.com/mkko/RxDrawerView.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "RxDrawerView/**/*.swift"
  # s.exclude_files = ""
